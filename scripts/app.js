...
import { MatchingGame } from './interactive/matching.js?v=20260712';
import { FillBlank } from './interactive/fillBlank.js?v=20260712';
import { CardCopy } from './interactive/cardCopy.js?v=20260712';
import { Showcase } from './interactive/showcase.js?v=20260712';
import { OrderingGame } from './interactive/ordering.js?v=20260712';
import { QuizGame } from './interactive/quiz.js?v=20260712';
import { PollGame } from './interactive/poll.js?v=20260712';
import { CountdownTimer } from './interactive/countdown.js?v=20260712';
import { TrueFalseGame } from './interactive/truefalse.js?v=20260712';
import { MultiChoiceGame } from './interactive/multiChoice.js?v=20260712';
import { OpenTextGame } from './interactive/opentext.js?v=20260712';
import { ScaleGame } from './interactive/scale.js?v=20260712';
import { BuzzerGame } from './interactive/buzzer.js?v=20260712';
import { WordCloudGame } from './interactive/wordcloud.js?v=20260712';
import { HotspotGame } from './interactive/hotspot.js?v=20260712';
import { DocumentViewer } from './interactive/documentViewer.js?v=20260712';

import { HomeworkSubmission } from './homework.js?v=20260712';
import { db, realtime, generateSessionCode, ai } from './supabase.js';
import { SLIDE_TEMPLATES } from './templates.js?v=20260712';
import { IconLibrary } from './iconLibrary.js?v=20260712';
import { SlideExporter } from './exportSlides.js?v=20260712';
   ...
   ========================================= */
    openTemplatePicker() {
        ...
        const renderGrid = (filter) => {
            ...
            const wireframes = {
                ...
                // 新增版型
                'swot': '<div style="padding:5px 8px;display:grid;grid-template-columns:1fr 1fr;grid-template-rows:1fr 1fr;gap:3px;height:100%;"><div style="background:#eff6ff;border-radius:3px;display:flex;align-items:center;justify-content:center;font-size:7px;font-weight:700;color:#1e40af;opacity:0.5;">S</div><div style="background:#fef2f2;border-radius:3px;display:flex;align-items:center;justify-content:center;font-size:7px;font-weight:700;color:#991b1b;opacity:0.5;">W</div><div style="background:#ecfdf5;border-radius:3px;display:flex;align-items:center;justify-content:center;font-size:7px;font-weight:700;color:#065f46;opacity:0.5;">O</div><div style="background:#fefce8;border-radius:3px;display:flex;align-items:center;justify-content:center;font-size:7px;font-weight:700;color:#92400e;opacity:0.5;">T</div></div>',
                'grid-4': '<div style="padding:5px 8px;display:grid;grid-template-columns:1fr 1fr;grid-template-rows:1fr 1fr;gap:3px;height:100%;"><div style="background:#eff6ff;border-radius:3px;"></div><div style="background:#ecfdf5;border-radius:3px;"></div><div style="background:#fefce8;border-radius:3px;"></div><div style="background:#fce7f3;border-radius:3px;"></div></div>',
                'grid-6': '<div style="padding:5px 8px;display:grid;grid-template-columns:1fr 1fr 1fr;grid-template-rows:1fr 1fr;gap:2px;height:100%;"><div style="background:#eff6ff;border-radius:2px;"></div><div style="background:#ecfdf5;border-radius:2px;"></div><div style="background:#fefce8;border-radius:2px;"></div><div style="background:#fce7f3;border-radius:2px;"></div><div style="background:#f5f3ff;border-radius:2px;"></div><div style="background:#fff7ed;border-radius:2px;"></div></div>',
                'big-number': '<div style="padding:8px 12px;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:2px;"><div style="font-size:18px;font-weight:900;color:#1e40af;opacity:0.4;">87%</div><div style="width:40%;height:2px;background:#93c5fd;opacity:0.3;border-radius:2px;"></div><div style="width:50%;height:2px;background:currentColor;opacity:0.08;border-radius:2px;"></div></div>',
                'icon-list': '<div style="padding:6px 10px;display:flex;flex-direction:column;gap:3px;height:100%;justify-content:center;"><div style="display:flex;align-items:center;gap:4px;background:#f8fafc;border-radius:3px;padding:3px 5px;"><span class="material-symbols-outlined" style="font-size:8px;color:#059669;opacity:0.5;">check_circle</span><div style="width:60%;height:2px;background:currentColor;opacity:0.1;border-radius:2px;"></div></div><div style="display:flex;align-items:center;gap:4px;padding:3px 5px;"><span class="material-symbols-outlined" style="font-size:8px;color:#d97706;opacity:0.5;">star</span><div style="width:50%;height:2px;background:currentColor;opacity:0.08;border-radius:2px;"></div></div><div style="display:flex;align-items:center;gap:4px;background:#f8fafc;border-radius:3px;padding:3px 5px;"><span class="material-symbols-outlined" style="font-size:8px;color:#2563eb;opacity:0.5;">bolt</span><div style="width:55%;height:2px;background:currentColor;opacity:0.1;border-radius:2px;"></div></div><div style="display:flex;align-items:center;gap:4px;padding:3px 5px;"><span class="material-symbols-outlined" style="font-size:8px;color:#dc2626;opacity:0.5;">favorite</span><div style="width:45%;height:2px;background:currentColor;opacity:0.08;border-radius:2px;"></div></div></div>',
                'pyramid': '<div style="padding:6px 12px;display:flex;flex-direction:column;align-items:center;gap:2px;height:100%;justify-content:center;"><div style="width:30%;height:16%;background:#1e40af;border-radius:2px;opacity:0.7;"></div><div style="width:50%;height:16%;background:#3b82f6;border-radius:2px;opacity:0.6;"></div><div style="width:70%;height:16%;background:#60a5fa;border-radius:2px;opacity:0.5;"></div><div style="width:90%;height:16%;background:#93c5fd;border-radius:2px;opacity:0.4;"></div></div>',
                'checklist': '<div style="padding:6px 10px;display:flex;flex-direction:column;gap:3px;height:100%;justify-content:center;"><div style="display:flex;align-items:center;gap:3px;background:#f0fdf4;border-radius:2px;padding:2px 4px;"><span class="material-symbols-outlined" style="font-size:8px;color:#059669;opacity:0.5;">check_box_outline_blank</span><div style="width:55%;height:2px;background:currentColor;opacity:0.1;border-radius:2px;"></div></div><div style="display:flex;align-items:center;gap:3px;background:#f0fdf4;border-radius:2px;padding:2px 4px;"><span class="material-symbols-outlined" style="font-size:8px;color:#059669;opacity:0.5;">check_box_outline_blank</span><div style="width:50%;height:2px;background:currentColor;opacity:0.1;border-radius:2px;"></div></div><div style="display:flex;align-items:center;gap:3px;background:#f0fdf4;border-radius:2px;padding:2px 4px;"><span class="material-symbols-outlined" style="font-size:8px;color:#059669;opacity:0.5;">check_box_outline_blank</span><div style="width:60%;height:2px;background:currentColor;opacity:0.1;border-radius:2px;"></div></div></div>',
                'pros-cons': '<div style="padding:6px 10px;display:flex;gap:4px;height:100%;align-items:center;"><div style="flex:1;background:#ecfdf5;border-radius:4px;height:80%;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:2px;"><span class="material-symbols-outlined" style="font-size:10px;color:#059669;opacity:0.5;">thumb_up</span><div style="width:50%;height:2px;background:#065f46;opacity:0.08;border-radius:2px;"></div></div><div style="flex:1;background:#fef2f2;border-radius:4px;height:80%;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:2px;"><span class="material-symbols-outlined" style="font-size:10px;color:#dc2626;opacity:0.5;">thumb_down</span><div style="width:50%;height:2px;background:#991b1b;opacity:0.08;border-radius:2px;"></div></div></div>',
                'three-row': '<div style="padding:6px 10px;display:flex;flex-direction:column;gap:3px;height:100%;justify-content:center;"><div style="background:#eff6ff;border-radius:3px;height:28%;border-left:3px solid #2563eb;"></div><div style="background:#ecfdf5;border-radius:3px;height:28%;border-left:3px solid #059669;"></div><div style="background:#fefce8;border-radius:3px;height:28%;border-left:3px solid #d97706;"></div></div>',
                'agenda': '<div style="padding:6px 10px;display:flex;flex-direction:column;gap:2px;height:100%;justify-content:center;"><div style="display:flex;gap:4px;background:#f8fafc;border-radius:2px;padding:3px 5px;"><span style="font-size:7px;color:#2563eb;font-weight:700;opacity:0.5;">09:00</span><div style="width:50%;height:2px;background:currentColor;opacity:0.1;border-radius:2px;align-self:center;"></div></div><div style="display:flex;gap:4px;padding:3px 5px;"><span style="font-size:7px;color:#2563eb;font-weight:700;opacity:0.5;">09:30</span><div style="width:55%;height:2px;background:currentColor;opacity:0.08;border-radius:2px;align-self:center;"></div></div><div style="display:flex;gap:4px;background:#f8fafc;border-radius:2px;padding:3px 5px;"><span style="font-size:7px;color:#2563eb;font-weight:700;opacity:0.5;">10:30</span><div style="width:45%;height:2px;background:currentColor;opacity:0.1;border-radius:2px;align-self:center;"></div></div></div>',
                'key-takeaway': '<div style="display:flex;flex-direction:column;height:100%;"><div style="height:18%;background:#1e293b;display:flex;align-items:center;padding-left:8px;"><span class="material-symbols-outlined" style="font-size:8px;color:#fbbf24;opacity:0.6;">auto_awesome</span></div><div style="flex:1;padding:4px 8px;display:flex;flex-direction:column;gap:2px;justify-content:center;"><div style="background:#eff6ff;border-radius:2px;height:26%;"></div><div style="background:#ecfdf5;border-radius:2px;height:26%;"></div><div style="background:#fefce8;border-radius:2px;height:26%;"></div></div></div>',
                'image-left': '<div style="display:flex;height:100%;gap:3px;padding:5px 8px;"><div style="flex:1;background:#f1f5f9;border-radius:4px;border:1px dashed #cbd5e1;display:flex;align-items:center;justify-content:center;"><span style="font-size:10px;opacity:0.3;">📷</span></div><div style="flex:1;display:flex;flex-direction:column;gap:2px;justify-content:center;padding:4px;"><div style="width:60%;height:4px;background:currentColor;opacity:0.2;border-radius:2px;"></div><div style="width:15px;height:1px;background:#2563eb;opacity:0.4;"></div><div style="width:80%;height:2px;background:currentColor;opacity:0.08;border-radius:2px;"></div><div style="width:70%;height:2px;background:currentColor;opacity:0.06;border-radius:2px;"></div></div></div>',
                'image-right': '<div style="display:flex;height:100%;gap:3px;padding:5px 8px;"><div style="flex:1;display:flex;flex-direction:column;gap:2px;justify-content:center;padding:4px;"><div style="width:60%;height:4px;background:currentColor;opacity:0.2;border-radius:2px;"></div><div style="width:15px;height:1px;background:#059669;opacity:0.4;"></div><div style="width:80%;height:2px;background:currentColor;opacity:0.08;border-radius:2px;"></div><div style="width:70%;height:2px;background:currentColor;opacity:0.06;border-radius:2px;"></div></div><div style="flex:1;background:#f0fdf4;border-radius:4px;border:1px dashed #bbf7d0;display:flex;align-items:center;justify-content:center;"><span style="font-size:10px;opacity:0.3;">📷</span></div></div>',
            };
    ...
    bindImg2Slide() {
        ...
        const runConvert = async () => {
            ...
            actionsEl.style.display = 'none';
            try {
                const { convertImage } = await import('./imageToSlide.js?v=20260712');
