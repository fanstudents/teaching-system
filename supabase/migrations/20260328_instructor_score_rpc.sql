...
GRANT EXECUTE ON FUNCTION public.instructor_score_submission(uuid, int) TO anon;
GRANT EXECUTE ON FUNCTION public.instructor_score_submission(uuid, int) TO authenticated;
